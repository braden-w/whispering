...
<nav class={cn('flex items-center', className)} style="view-transition-name: nav">
	<WhisperingTooltip tooltipText="Recordings" href="/recordings" variant="ghost" size="icon">
		<ListIcon class="h-4 w-4" aria-hidden="true" />
	</WhisperingTooltip>
	<WhisperingTooltip tooltipText="Settings" href="/settings" variant="ghost" size="icon">
